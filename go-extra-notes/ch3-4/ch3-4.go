...
// It works as a contract for creating various employee types in a team
// This contract provides two behaviors
...
type Team struct {
	...
	TeamMembers		  []TeamMember // slice of type TeamMember interface
}
